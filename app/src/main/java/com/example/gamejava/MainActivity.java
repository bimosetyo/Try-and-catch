    ...
    public void onGuess(View view) {
        ...
        try {
            ...
            if (guessedNumber < 1 || guessedNumber > 20) {
                message = " silahkan masukkan nila berupa angka dari 1 sampai 20 !!";
            } else if (guessedNumber < randomNumber) {
                message = "Nilai angka terlalu rendah !!!";
            } else if (guessedNumber > randomNumber) {
                message = "Nilai angka  terlalu tinggi !!!";
            }else {
                message = "You Got Me !!!";
                randomNumberGenerator(); //aplikasi yang berulang sampai bertemu solusi
            }
        } catch (Exception e){
